...
- [User Guide](user.md)
  - [Basics](./basics.md)
  - [Configuring Backends](./config.md)
  - [Types](./types.md)
    - [Opaque types](./types/opaque.md)
    - [Structs and enums](./types/structs.md)
    - [Traits](./types/traits.md)
    - [Options](./types/option.md)
    - [Results](./types/result.md)
    - [Callbacks](./types/callbacks.md)
    - [Returning Strings: Writeable](./types/write.md)
  ...
  - [Customizing via attributes](attrs.md)
    ...
    - [Fallible Callback Returns](attrs/fallible_callback_returns.md)

...
import { Float64Vec } from "./Float64Vec.mjs"
...
export class MyString {
    ...
    static newOwned(v) {
        ...
        const vSlice = diplomatRuntime.OwnedSliceLeaker.alloc(diplomatRuntime.DiplomatBuf.sliceWrapper(wasm, diplomatRuntime.DiplomatBuf.str8(wasm, v)));

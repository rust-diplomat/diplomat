...
export class Utf16Wrap {
    ...
    #defaultConstructor(input) {
        ...
        const inputSlice = diplomatRuntime.FUNCTION_PARAM_ALLOC.alloc(diplomatRuntime.DiplomatBuf.sliceWrapper(wasm, diplomatRuntime.DiplomatBuf.str16(wasm, input)));

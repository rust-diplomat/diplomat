...
#defaultConstructor(a, b) {
        ...
        const result = wasm.namespace_StructWithAttrs_new(diplomatReceive.buffer, a, b);
...
#defaultConstructor(a) {
        ...
        const result = wasm.namespace_StructWithAttrs_new_fallible(diplomatReceive.buffer, a);

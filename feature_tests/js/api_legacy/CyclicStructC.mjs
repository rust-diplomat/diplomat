...
export class CyclicStructC {
    ...
    */
    ...
    _intoFFI(
        ...
        return [...CyclicStructA._fromSuppliedValue(diplomatRuntime.internalConstructor, this.#a)._intoFFI({})]
    }
    ...
    static takesNestedParameters(c) {
        ...
        const result = wasm.CyclicStructC_takes_nested_parameters(...CyclicStructC._fromSuppliedValue(diplomatRuntime.internalConstructor, c)._intoFFI({}));
    ...
    cyclicOut() {
        ...
        wasm.CyclicStructC_cyclic_out(...CyclicStructC._fromSuppliedValue(diplomatRuntime.internalConstructor, this)._intoFFI({}), write.buffer);

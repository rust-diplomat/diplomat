...
/**
 * {@snippet lang=c :
 * struct ResultOpaque_new_failing_foo_result {
 *     union {
 *         ResultOpaque *ok;
 *         ErrorEnum err;
 *     };
 ...
 * }
 */
public class ResultOpaque_new_failing_foo_result {

    ResultOpaque_new_failing_foo_result() {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ...
            somelib_h.C_INT.withName("err")
        ).withName("$anon$23:45"),
        somelib_h.C_BOOL.withName("is_ok"),
        MemoryLayout.paddingLayout(7)
    ).withName("ResultOpaque_new_failing_foo_result");
    ...
    private static final AddressLayout ok$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$23:45"), groupElement("ok"));
    ...
    private static final OfInt err$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$23:45"), groupElement("err"));

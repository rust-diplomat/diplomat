...
/**
 * {@snippet lang=c :
 * struct namespace_MyIndexer_get_result {
 *     union {
 ...
 * }
 */
public class namespace_MyIndexer_get_result {

    namespace_MyIndexer_get_result() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            DiplomatStringView.layout().withName("ok")
        ).withName("$anon$18:40"),
        somelib_h.C_BOOL.withName("is_ok"),
        MemoryLayout.paddingLayout(7)
    ).withName("namespace_MyIndexer_get_result");
    ...
    private static final GroupLayout ok$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$18:40"), groupElement("ok"));

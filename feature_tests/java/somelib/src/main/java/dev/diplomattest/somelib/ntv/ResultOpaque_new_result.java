...
/**
 * {@snippet lang=c :
 * struct ResultOpaque_new_result {
 *     union {
 *         ResultOpaque *ok;
 *         ErrorEnum err;
 *     };
 ...
 * }
 */
public class ResultOpaque_new_result {

    ResultOpaque_new_result() {
    ...
    ).withName("ResultOpaque_new_result");
    ...
    private static final AddressLayout ok$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$20:33"), groupElement("ok"));
    ...
    private static final OfInt err$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20:33"), groupElement("err"));

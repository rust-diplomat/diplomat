...
/**
 * {@snippet lang=c :
 * struct OptionOpaque_option_isize_result {
 *     union {
 *         intptr_t ok;
 *     };
 *     bool is_ok;
 ...
 * }
 */
public class OptionOpaque_option_isize_result {

    OptionOpaque_option_isize_result() {
    ...
    ).withName("OptionOpaque_option_isize_result");
    ...
    private static final OfLong ok$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$26:42"), groupElement("ok"));

 ...
 * }
 */
public class ResultOpaque_new_failing_bar_result {

    ResultOpaque_new_failing_bar_result() {
    ...
    ).withName("ResultOpaque_new_failing_bar_result");
    ...
    private static final AddressLayout ok$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$26:45"), groupElement("ok"));
    ...
    private static final OfInt err$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$26:45"), groupElement("err"));

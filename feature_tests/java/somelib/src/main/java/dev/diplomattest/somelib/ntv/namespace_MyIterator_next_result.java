...
/**
 * {@snippet lang=c :
 * struct namespace_MyIterator_next_result {
 *     union {
 *         uint8_t ok;
 *     };
 *     bool is_ok;
 ...
 * }
 */
public class namespace_MyIterator_next_result {

    namespace_MyIterator_next_result() {
    ...
    ).withName("namespace_MyIterator_next_result");
    ...
    private static final OfByte ok$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$18:42"), groupElement("ok"));

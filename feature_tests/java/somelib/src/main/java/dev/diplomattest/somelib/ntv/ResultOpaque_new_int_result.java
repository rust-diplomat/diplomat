...
/**
 * {@snippet lang=c :
 * struct ResultOpaque_new_int_result {
 *     union {
 *         int32_t ok;
 *     };
 *     bool is_ok;
 ...
 * }
 */
public class ResultOpaque_new_int_result {

    ResultOpaque_new_int_result() {
    ...
    ).withName("ResultOpaque_new_int_result");
    ...
    private static final OfInt ok$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$38:37"), groupElement("ok"));

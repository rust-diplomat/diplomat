...
/**
 * {@snippet lang=c :
 * struct ResultOpaque_new_in_enum_err_result {
 *     union {
 *         ErrorEnum ok;
 *         ResultOpaque *err;
 *     };
 ...
 * }
 */
public class ResultOpaque_new_in_enum_err_result {

    ResultOpaque_new_in_enum_err_result() {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ...
            somelib_h.C_POINTER.withName("err")
        ).withName("$anon$41:45"),
        somelib_h.C_BOOL.withName("is_ok"),
        MemoryLayout.paddingLayout(7)
    ).withName("ResultOpaque_new_in_enum_err_result");
    ...
    private static final OfInt ok$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$41:45"), groupElement("ok"));
    ...
    private static final AddressLayout err$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$41:45"), groupElement("err"));

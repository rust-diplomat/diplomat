...
/**
 * {@snippet lang=c :
 * struct OptionOpaque_option_usize_result {
 *     union {
 *         size_t ok;
 *     };
 *     bool is_ok;
 ...
 * }
 */
public class OptionOpaque_option_usize_result {

    OptionOpaque_option_usize_result() {
    ...
    ).withName("OptionOpaque_option_usize_result");
    ...
    private static final OfLong ok$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$29:42"), groupElement("ok"));

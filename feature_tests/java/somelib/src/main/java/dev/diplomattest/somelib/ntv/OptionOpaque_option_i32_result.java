...
/**
 * {@snippet lang=c :
 * struct OptionOpaque_option_i32_result {
 *     union {
 *         int32_t ok;
 *     };
 *     bool is_ok;
 ...
 * }
 */
public class OptionOpaque_option_i32_result {

    OptionOpaque_option_i32_result() {
    ...
    ).withName("OptionOpaque_option_i32_result");
    ...
    private static final OfInt ok$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$32:40"), groupElement("ok"));

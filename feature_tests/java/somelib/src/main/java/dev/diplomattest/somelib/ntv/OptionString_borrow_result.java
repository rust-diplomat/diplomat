...
/**
 * {@snippet lang=c :
 * struct OptionString_borrow_result {
 *     union {
 ...
 * }
 */
public class OptionString_borrow_result {

    OptionString_borrow_result() {
    ...
    ).withName("OptionString_borrow_result");
    ...
    private static final GroupLayout ok$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$23:36"), groupElement("ok"));

 ...
 * }
 */
public class ErrorStruct_option {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ErrorStruct.layout().withName("ok")
        ).withName("$anon$19:36"),
        somelib_h.C_BOOL.withName("is_ok"),
        MemoryLayout.paddingLayout(3)
    ).withName("ErrorStruct_option");
    ...
    private static final GroupLayout ok$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$19:36"), groupElement("ok"));

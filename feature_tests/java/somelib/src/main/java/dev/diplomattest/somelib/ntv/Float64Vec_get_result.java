 ...
 * }
 */
public class Float64Vec_get_result {

    Float64Vec_get_result() {
    ...
    ).withName("Float64Vec_get_result");
    ...
    private static final OfDouble ok$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$44:31"), groupElement("ok"));

...
/**
 * {@snippet lang=c :
 * struct MyStruct_returns_zst_result_result {
 *     bool is_ok;
 * }
 * }
 */
public class MyStruct_returns_zst_result_result {

    MyStruct_returns_zst_result_result() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        somelib_h.C_BOOL.withName("is_ok")
    ).withName("MyStruct_returns_zst_result_result");

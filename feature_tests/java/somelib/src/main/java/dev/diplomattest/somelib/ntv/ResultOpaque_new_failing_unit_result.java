...
/**
 * {@snippet lang=c :
 * struct ResultOpaque_new_failing_unit_result {
 *     union {
 *         ResultOpaque *ok;
 *     };
 *     bool is_ok;
 ...
 * }
 */
public class ResultOpaque_new_failing_unit_result {

    ResultOpaque_new_failing_unit_result() {
    ...
    ).withName("ResultOpaque_new_failing_unit_result");
    ...
    private static final AddressLayout ok$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$29:46"), groupElement("ok"));

...
/**
 * {@snippet lang=c :
 * struct ResultOpaque_new_failing_struct_result {
 *     union {
 *         ResultOpaque *ok;
 *         ErrorStruct err;
 *     };
 ...
 * }
 */
public class ResultOpaque_new_failing_struct_result {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            somelib_h.C_POINTER.withName("ok"),
            ErrorStruct.layout().withName("err")
        ).withName("$anon$32:48"),
        somelib_h.C_BOOL.withName("is_ok"),
        MemoryLayout.paddingLayout(7)
    ).withName("ResultOpaque_new_failing_struct_result");
    ...
    private static final AddressLayout ok$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$32:48"), groupElement("ok"));
    ...
    private static final GroupLayout err$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$32:48"), groupElement("err"));
     ...
     * }
     */
    public static final GroupLayout err$layout() {
        return err$LAYOUT;
    }
    ...
    public static MemorySegment err(MemorySegment struct) {
        return struct.asSlice(err$OFFSET, err$LAYOUT.byteSize());
    }
    ...
    public static void err(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, err$OFFSET, err$LAYOUT.byteSize());
    }

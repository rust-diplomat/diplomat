...
/**
 * {@snippet lang=c :
 * struct OptionOpaque_option_u32_result {
 *     union {
 *         uint32_t ok;
 *     };
 *     bool is_ok;
 ...
 * }
 */
public class OptionOpaque_option_u32_result {

    OptionOpaque_option_u32_result() {
    ...
    ).withName("OptionOpaque_option_u32_result");
    ...
    private static final OfInt ok$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$35:40"), groupElement("ok"));

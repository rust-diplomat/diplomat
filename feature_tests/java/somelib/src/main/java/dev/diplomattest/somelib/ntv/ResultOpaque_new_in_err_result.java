...
/**
 * {@snippet lang=c :
 * struct ResultOpaque_new_in_err_result {
 *     union {
 *         ResultOpaque *err;
 *     };
 *     bool is_ok;
 ...
 * }
 */
public class ResultOpaque_new_in_err_result {

    ResultOpaque_new_in_err_result() {
    ...
    ).withName("ResultOpaque_new_in_err_result");
    ...
    private static final AddressLayout err$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$35:40"), groupElement("err"));

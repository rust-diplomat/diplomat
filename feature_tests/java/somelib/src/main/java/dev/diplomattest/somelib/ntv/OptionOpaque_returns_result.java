...
/**
 * {@snippet lang=c :
 * struct OptionOpaque_returns_result {
 *     union {
 *         OptionStruct ok;
 *     };
 *     bool is_ok;
 ...
 * }
 */
public class OptionOpaque_returns_result {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            OptionStruct.layout().withName("ok")
        ).withName("$anon$23:37"),
        somelib_h.C_BOOL.withName("is_ok"),
        MemoryLayout.paddingLayout(7)
    ).withName("OptionOpaque_returns_result");
    ...
    private static final GroupLayout ok$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$23:37"), groupElement("ok"));

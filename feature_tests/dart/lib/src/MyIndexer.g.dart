...
final class MyIndexer implements ffi.Finalizable {
  ...
  MyIndexer._fromFfi(this._ffi, this._selfEdge) {
...
@ffi.Native<_ResultUint8Void Function(ffi.Pointer<ffi.Opaque>, ffi.Size)>(isLeaf: true, symbol: 'namespace_MyIndexer_get')
// ignore: non_constant_identifier_names
external _ResultUint8Void _namespace_MyIndexer_get(ffi.Pointer<ffi.Opaque> self, int i);

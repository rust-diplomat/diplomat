...
final class RenamedNested2 implements ffi.Finalizable {
  ...
  RenamedNested2._fromFfi(this._ffi, this._selfEdge) {
    if (_selfEdge.isEmpty) {
      $d_namespace_Nested2_destroy(this, _ffi.cast());
    }
  }

  @meta.RecordUse()
  static void $d_namespace_Nested2_destroy(RenamedNested2 cl, ffi.Pointer<ffi.Void> pointer) => _finalizer.attach(cl, pointer);

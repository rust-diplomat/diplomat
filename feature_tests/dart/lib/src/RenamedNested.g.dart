...
final class RenamedNested implements ffi.Finalizable {
  ...
  RenamedNested._fromFfi(this._ffi, this._selfEdge) {
    if (_selfEdge.isEmpty) {
      $d_namespace_Nested_destroy(this, _ffi.cast());
    }
  }

  @meta.RecordUse()
  static void $d_namespace_Nested_destroy(RenamedNested cl, ffi.Pointer<ffi.Void> pointer) => _finalizer.attach(cl, pointer);

...
final class RenamedAttrOpaque2 implements ffi.Finalizable {
  ...
  RenamedAttrOpaque2._fromFfi(this._ffi, this._selfEdge) {
    if (_selfEdge.isEmpty) {
      $d_namespace_AttrOpaque2_destroy(this, _ffi.cast());
    }
  }

  @meta.RecordUse()
  static void $d_namespace_AttrOpaque2_destroy(RenamedAttrOpaque2 cl, ffi.Pointer<ffi.Void> pointer) => _finalizer.attach(cl, pointer);

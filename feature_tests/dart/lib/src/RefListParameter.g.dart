...
final class RefListParameter implements ffi.Finalizable {
  ...
  RefListParameter._fromFfi(this._ffi, this._selfEdge) {
    if (_selfEdge.isEmpty) {
      $d_RefListParameter_destroy(this, _ffi.cast());
    }
  }

  @meta.RecordUse()
  static void $d_RefListParameter_destroy(RefListParameter cl, ffi.Pointer<ffi.Void> pointer) => _finalizer.attach(cl, pointer);

...
inline diplomat::capi::OptionInputStruct OptionInputStruct::AsFFI() const {
  return diplomat::capi::OptionInputStruct {
    /* .a = */ a.has_value() ? (diplomat::capi::OptionU8){ { a.value() }, true } : (diplomat::capi::OptionU8){ {}, true },
    /* .b = */ b.has_value() ? (diplomat::capi::OptionChar){ { b.value() }, true } : (diplomat::capi::OptionChar){ {}, true },
    /* .c = */ c.has_value() ? (diplomat::capi::OptionEnum_option){ { c.value().AsFFI() }, true } : (diplomat::capi::OptionEnum_option){ {}, true },
  };
}

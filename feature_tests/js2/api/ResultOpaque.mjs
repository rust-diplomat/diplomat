...
export class ResultOpaque {
    ...
    static new_(i) {const result = wasm.ResultOpaque_new(i);
    ...
    static newFailingFoo() {const result = wasm.ResultOpaque_new_failing_foo();
    ...
    static newFailingBar() {const result = wasm.ResultOpaque_new_failing_bar();
    ...
    static newFailingStruct(i) {const result = wasm.ResultOpaque_new_failing_struct(i);
    ...
    static newInErr(i) {const result = wasm.ResultOpaque_new_in_err(i);
    ...
    static newInEnumErr(i) {const result = wasm.ResultOpaque_new_in_enum_err(i);

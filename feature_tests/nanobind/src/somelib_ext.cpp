...
NB_MODULE(somelib, somelib_mod)
{
    ...
    nb::class_<OptionOpaque>(somelib_mod, "OptionOpaque", nb::type_slots(OptionOpaque_slots))
    	...
    	.def_static("accepts_option_u8", &OptionOpaque::accepts_option_u8, "arg"_a= nb::none())
    	.def_static("accepts_option_enum", &OptionOpaque::accepts_option_enum, "arg"_a= nb::none())
    	.def_static("accepts_option_input_struct", &OptionOpaque::accepts_option_input_struct, "arg"_a= nb::none())

...
void add_TupleStruct_binding(nb::module_ mod) {
    ...
    st
        ...
        .def_static("takes_st_as_tuple", nb::overload_cast<std::tuple<int32_t,int32_t,somelib::MyStruct,somelib::Opaque*>>(&somelib::TupleStruct::takes_st_as_tuple), "a"_a)
        .def_static("takes_st_as_tuple", nb::overload_cast<std::tuple<int32_t,int32_t,somelib::MyStruct,somelib::Opaque*>, int32_t>(&somelib::TupleStruct::takes_st_as_tuple), "a"_a, "i"_a);
}

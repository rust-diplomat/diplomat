...
void add_RenamedOpaqueArithmetic_binding(nb::module_ mod) {
    ...
    opaque
        ...
        .def_static("make", std::move(maybe_op_unwrap(nb::overload_cast<float, float, std::optional<float>>(&somelib::ns::RenamedOpaqueArithmetic::make))), "x"_a, "y"_a=14.48, "z"_a=0)

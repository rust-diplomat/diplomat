...
void add_RenamedOpaqueArithmetic_binding(nb::module_ mod) {
    nb::class_<somelib::ns::RenamedOpaqueArithmetic> opaque(mod, "RenamedOpaqueArithmetic");
    opaque
        ...
        .def(nb::self /= nb::self, nb::rv_policy::none)
        .def_static("make", std::move(maybe_op_unwrap(nb::overload_cast<int32_t, int32_t>(&somelib::ns::RenamedOpaqueArithmetic::make))), "x"_a, "y"_a=12)
        .def_static("make", std::move(maybe_op_unwrap(nb::overload_cast<float, float, somelib::diplomat::Optional<float>>(&somelib::ns::RenamedOpaqueArithmetic::make))), "x"_a, "y"_a=14.48, "z"_a=0)

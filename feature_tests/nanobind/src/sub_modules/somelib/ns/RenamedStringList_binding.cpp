...
void add_RenamedStringList_binding(nb::module_ mod) {
    ...
    // nb::class_<somelib::ns::RenamedStringList>(mod, "RenamedStringList", nb::type_slots(somelib_ns_RenamedStringList_slots))
    //     .def_static("return_new", &somelib::ns::RenamedStringList::return_new);
    mod.def("return_new", &somelib::ns::RenamedStringList::return_new);
}

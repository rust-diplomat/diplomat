...
void add_OpaqueMutexedString_binding(nb::handle mod) {
    ...
    nb::class_<OpaqueMutexedString>(mod, "OpaqueMutexedString", nb::type_slots(OpaqueMutexedString_slots))
    	.def("borrow", &OpaqueMutexedString::borrow, nb::keep_alive<0, 1>(), nb::rv_policy::reference_internal)
    	.def_static("borrow_other", &OpaqueMutexedString::borrow_other, "other"_a, nb::keep_alive<0, 1>(), nb::rv_policy::reference_internal)
    	.def("borrow_self_or_other", &OpaqueMutexedString::borrow_self_or_other, "other"_a, nb::keep_alive<0, 1>(), nb::keep_alive<0, 2>(), nb::rv_policy::reference_internal)

...
class BorrowingOptionStruct:
    ...
    @overload
    def __init__(self, a: str | None | None) -> None: ...

    @property
    def a(self) -> str | None: ...

    @a.setter
    def a(self, arg: str | None, /) -> None: ...
...
class CallbackWrapper:
    ...
    @staticmethod
    def test_option_opaque(t: Callable[[], Opaque | None]) -> str: ...
...
class MyString:
    ...
    @staticmethod
    def optional_slice_of_opaques(sl: Sequence[MyString | None]) -> str: ...
...
class MyStructContainingAnOption:
    ...
    @a.setter
    def a(self, arg: MyStruct | None, /) -> None: ...

    @property
    def b(self) -> DefaultEnum | None: ...

    @b.setter
    def b(self, arg: DefaultEnum | None, /) -> None: ...
...
class Opaque:
    ...
    @staticmethod
    def try_from_utf8(input: str) -> Opaque | None: ...

class OpaqueCallbacks:
    def __init__(self, f: Callable[[MyString], MyString], st: MyString) -> None: ...

    def opaque_cb_mut_self(self, cb: Callable[[MyString], MyString], st: MyString) -> MyString: ...

    def opaque_cb_self(self, cb: Callable[[MyString], MyString], st: MyString) -> MyString: ...
...
class OpaqueThinIter:
    def __next__(self) -> OpaqueThin | None: ...
...
class OpaqueThinVec:
    ...
    @property
    def first(self) -> OpaqueThin | None: ...

    def __getitem__(self, idx: int) -> OpaqueThin | None: ...
...
class OptionInputStruct:
    ...
    @overload
    def __init__(self, a: int | None | None, b: str | None | None, c: OptionEnum | None | None) -> None: ...

    @property
    def a(self) -> int | None: ...

    @a.setter
    def a(self, arg: int | None, /) -> None: ...

    @property
    def b(self) -> str | None: ...

    @b.setter
    def b(self, arg: str | None, /) -> None: ...

    @property
    def c(self) -> OptionEnum | None: ...

    @c.setter
    def c(self, arg: OptionEnum | None, /) -> None: ...
...
class OptionOpaque:
    ...
    @staticmethod
    def accepts_multiple_option_enum(sentinel1: int, arg1: OptionEnum | None | None = None, arg2: OptionEnum | None | None = None, arg3: OptionEnum | None | None = None, sentinel2: int) -> OptionEnum | None: ...

    @staticmethod
    def accepts_option_enum(arg: OptionEnum | None | None = None, sentinel: int) -> OptionEnum | None: ...

    @staticmethod
    def accepts_option_input_struct(arg: OptionInputStruct | None | None = None, sentinel: int) -> OptionInputStruct | None: ...

    @staticmethod
    def accepts_option_primitive(arg: Sequence[int] | None | None = None, sentinel: int) -> int: ...

    @staticmethod
    def accepts_option_str(arg: str | None | None = None, sentinel: int) -> int: ...

    @staticmethod
    def accepts_option_str_slice(arg: Sequence[str] | None | None = None, sentinel: int) -> bool: ...

    @staticmethod
    def accepts_option_u8(arg: int | None | None = None, sentinel: int) -> int | None: ...

    def assert_integer(self, i: int) -> None: ...

    @staticmethod
    def new(i: int) -> OptionOpaque | None: ...

    @staticmethod
    def new_none() -> OptionOpaque | None: ...
    ...
    @staticmethod
    def option_opaque_argument(arg: OptionOpaque | None | None = None) -> bool: ...
    ...
    def returns_none_self(self) -> OptionOpaque | None: ...

    @staticmethod
    def returns_option_input_struct() -> OptionInputStruct: ...

    def returns_some_self(self) -> OptionOpaque | None: ...
...
class OptionString:
    ...
    @staticmethod
    def new(diplomat_str: str) -> OptionString | None: ...

    def write(self) -> str: ...

class OptionStruct:
    @property
    def a(self) -> OptionOpaque | None: ...

    @property
    def b(self) -> OptionOpaqueChar | None: ...

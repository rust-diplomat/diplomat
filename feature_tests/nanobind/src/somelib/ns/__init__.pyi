...
class RenamedOpaqueArithmetic:
    ...
    @overload
    @staticmethod
    def make(x: float, y: float = 14.48, z: float = 0) -> RenamedOpaqueArithmetic: ...
...
class RenamedOpaqueIterator:
    def __next__(self) -> AttrOpaque1Renamed: ...
...
class RenamedOpaqueZST:
    ...
    def __getitem__(self, _idx: int) -> RenamedOpaqueZST: ...
    ...
    @staticmethod
    def optional_zst(is_some: bool) -> RenamedOpaqueZST: ...
...
class RenamedOpaqueZSTIndexer:
    ...
    def __getitem__(self, idx: int) -> RenamedOpaqueZSTIndexer: ...
...
class RenamedOpaqueZSTIterator:
    ...
    def __next__(self) -> RenamedOpaqueZSTIterator: ...

    def __iter__(self) -> object: ...

    def __getitem__(self, _idx: int) -> RenamedOpaqueZSTIterator: ...

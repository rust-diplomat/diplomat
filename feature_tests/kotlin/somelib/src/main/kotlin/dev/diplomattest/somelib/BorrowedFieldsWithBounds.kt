...
internal interface BorrowedFieldsWithBoundsLib : Library {
    fun BorrowedFieldsWithBounds_from_foo_and_strings(
            foo: Pointer,
            dstr16X: Slice,
            utf8StrZ: Slice
    ): BorrowedFieldsWithBoundsNative
}

class BorrowedFieldsWithBoundsNative : Structure(), Structure.ByValue {
    @JvmField var fieldA: Slice = Slice()
    @JvmField var fieldB: Slice = Slice()
    @JvmField var fieldC: Slice = Slice()
...
internal constructor(
    ...
    companion object {
        internal val libClass: Class<BorrowedFieldsWithBoundsLib> =
                BorrowedFieldsWithBoundsLib::class.java
        internal val lib: BorrowedFieldsWithBoundsLib = Native.load("somelib", libClass)
        val NATIVESIZE: Long =
                Native.getNativeSize(BorrowedFieldsWithBoundsNative::class.java).toLong()
        fun fromFooAndStrings(
                foo: Foo,
                dstr16X: String,
                utf8StrZ: String
            ...
            val returnVal =
                    lib.BorrowedFieldsWithBounds_from_foo_and_strings(
                            foo.handle,
                            dstr16XSlice,
                            utf8StrZSlice
                    )

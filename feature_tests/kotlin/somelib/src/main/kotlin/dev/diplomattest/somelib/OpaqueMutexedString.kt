...
internal constructor(
    ...
    internal class OpaqueMutexedStringCleaner(
            val handle: Pointer,
            val lib: OpaqueMutexedStringLib
    ) : Runnable {
        override fun run() {
    ...
    companion object {
        ...
        fun fromUsize(number: Long): OpaqueMutexedString {

            val returnVal = lib.OpaqueMutexedString_from_usize(number)
            ...
            CLEANER.register(
                    returnOpaque,
                    OpaqueMutexedString.OpaqueMutexedStringCleaner(handle, OpaqueMutexedString.lib)
            )
    ...
    fun getLenAndAdd(other: Long): Long {
        ...
        val returnVal = lib.OpaqueMutexedString_get_len_and_add(handle, other)
        return returnVal
    }
    fun dummyStr(): String {

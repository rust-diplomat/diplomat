...
internal interface NestedBorrowedFieldsLib : Library {
    fun NestedBorrowedFields_from_bar_and_foo_and_strings(
            bar: Pointer,
            foo: Pointer,
            dstr16X: Slice,
            dstr16Z: Slice,
            utf8StrY: Slice,
            utf8StrZ: Slice
    ): NestedBorrowedFieldsNative
}

class NestedBorrowedFieldsNative : Structure(), Structure.ByValue {
    @JvmField var fields: BorrowedFieldsNative = BorrowedFieldsNative()
    @JvmField var bounds: BorrowedFieldsWithBoundsNative = BorrowedFieldsWithBoundsNative()
    @JvmField var bounds2: BorrowedFieldsWithBoundsNative = BorrowedFieldsWithBoundsNative()
...
internal constructor(
    ...
    val bounds: BorrowedFieldsWithBounds =
            BorrowedFieldsWithBounds(nativeStruct.bounds, xEdges, yEdges, yEdges)
    val bounds2: BorrowedFieldsWithBounds =
            BorrowedFieldsWithBounds(nativeStruct.bounds2, zEdges, zEdges, zEdges)
    ...
    companion object {
        ...
        fun fromBarAndFooAndStrings(
            ...
            val returnVal =
                    lib.NestedBorrowedFields_from_bar_and_foo_and_strings(
                            bar.handle,
                            foo.handle,
                            dstr16XSlice,
                            dstr16ZSlice,

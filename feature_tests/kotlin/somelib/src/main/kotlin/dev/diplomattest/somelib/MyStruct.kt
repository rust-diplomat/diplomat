...
class MyStructNative : Structure(), Structure.ByValue {
    ...
    @JvmField var c: Byte = 0
    @JvmField var d: Long = 0
    @JvmField var e: Int = 0
    @JvmField var f: Int = 0
    @JvmField var g: Int = MyEnum.default().toNative()
...
class MyStruct internal constructor(internal val nativeStruct: MyStructNative) {

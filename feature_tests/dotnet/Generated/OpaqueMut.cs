...
public partial class OpaqueMut
{
    ...
    /// </remarks>
    internal unsafe OpaqueMut(Raw.OpaqueMut* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.OpaqueMut>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe OpaqueMut(Raw.OpaqueMut* handle, object[] pins)
    {
        _inner = RustHandle<Raw.OpaqueMut>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe OpaqueMut(Raw.OpaqueMut* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.OpaqueMut>.Owned(handle, _destroy, dependencies, pins);
    }

...
public partial class RenamedDeprecatedOpaque
{
    ...
    /// </remarks>
    internal unsafe RenamedDeprecatedOpaque(Raw.RenamedDeprecatedOpaque* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.RenamedDeprecatedOpaque>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe RenamedDeprecatedOpaque(Raw.RenamedDeprecatedOpaque* handle, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedDeprecatedOpaque>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe RenamedDeprecatedOpaque(Raw.RenamedDeprecatedOpaque* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedDeprecatedOpaque>.Owned(handle, _destroy, dependencies, pins);
    }

...
public partial class RefListParameter
{
    ...
    {
        _inner = RustHandle<Raw.RefListParameter>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RustHandle<Raw.RefListParameter>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RustHandle<Raw.RefListParameter>.Owned(handle, _destroy, dependencies, pins);
    }

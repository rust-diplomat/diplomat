...
public partial class RenamedNested2
{
    ...
    /// </remarks>
    internal unsafe RenamedNested2(Raw.RenamedNested2* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.RenamedNested2>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe RenamedNested2(Raw.RenamedNested2* handle, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedNested2>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe RenamedNested2(Raw.RenamedNested2* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedNested2>.Owned(handle, _destroy, dependencies, pins);
    }

...
public partial class Bar
{
    ...
    public Foo Foo
    {
        get
        {
            unsafe
            {
                ...
                GC.KeepAlive(this);
                return new Foo(RustHandle<Raw.Foo>.Borrowed(result, new IRustHandleDependency[] { this.DiplomatRetainDependency() }));
            }
        }
    }
    ...
    {
        _inner = RustHandle<Raw.Bar>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RustHandle<Raw.Bar>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RustHandle<Raw.Bar>.Owned(handle, _destroy, dependencies, pins);
    }

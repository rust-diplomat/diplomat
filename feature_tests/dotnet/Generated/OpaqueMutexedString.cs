...
public partial class OpaqueMutexedString: IDisposable
{
    ...
    {
        _inner = RustHandle<Raw.OpaqueMutexedString>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RustHandle<Raw.OpaqueMutexedString>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RustHandle<Raw.OpaqueMutexedString>.Owned(handle, _destroy, dependencies, pins);
    }

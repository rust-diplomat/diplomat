...
public partial class GcRaceProbe
{
    ...
    /// </remarks>
    internal unsafe GcRaceProbe(Raw.GcRaceProbe* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.GcRaceProbe>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe GcRaceProbe(Raw.GcRaceProbe* handle, object[] pins)
    {
        _inner = RustHandle<Raw.GcRaceProbe>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe GcRaceProbe(Raw.GcRaceProbe* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.GcRaceProbe>.Owned(handle, _destroy, dependencies, pins);
    }

...
public partial class BorrowingError
{
    ...
    {
        _inner = RustHandle<Raw.BorrowingError>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RustHandle<Raw.BorrowingError>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RustHandle<Raw.BorrowingError>.Owned(handle, _destroy, dependencies, pins);
    }

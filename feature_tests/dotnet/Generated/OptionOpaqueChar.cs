...
public partial class OptionOpaqueChar
{
    ...
    /// </remarks>
    internal unsafe OptionOpaqueChar(Raw.OptionOpaqueChar* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.OptionOpaqueChar>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe OptionOpaqueChar(Raw.OptionOpaqueChar* handle, object[] pins)
    {
        _inner = RustHandle<Raw.OptionOpaqueChar>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe OptionOpaqueChar(Raw.OptionOpaqueChar* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.OptionOpaqueChar>.Owned(handle, _destroy, dependencies, pins);
    }

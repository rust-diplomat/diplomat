...
public partial class RcSource: IDisposable
{
    ...
    {
        _inner = RustHandle<Raw.RcSource>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RustHandle<Raw.RcSource>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RustHandle<Raw.RcSource>.Owned(handle, _destroy, dependencies, pins);
    }
    ...
    public RcSource View()
    {
        unsafe
        {
            ...
            GC.KeepAlive(this);
            return new RcSource(RustHandle<Raw.RcSource>.Borrowed(result, new IRustHandleDependency[] { this.DiplomatRetainDependency() }));
        }
    }

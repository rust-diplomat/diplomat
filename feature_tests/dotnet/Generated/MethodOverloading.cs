...
public partial class MethodOverloading: IDisposable
{
    ...
    /// </remarks>
    internal unsafe MethodOverloading(Raw.MethodOverloading* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.MethodOverloading>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe MethodOverloading(Raw.MethodOverloading* handle, object[] pins)
    {
        _inner = RustHandle<Raw.MethodOverloading>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe MethodOverloading(Raw.MethodOverloading* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.MethodOverloading>.Owned(handle, _destroy, dependencies, pins);
    }

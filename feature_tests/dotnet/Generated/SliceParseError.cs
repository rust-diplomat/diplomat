...
public partial class SliceParseError
{
    ...
    /// </remarks>
    internal unsafe SliceParseError(Raw.SliceParseError* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.SliceParseError>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe SliceParseError(Raw.SliceParseError* handle, object[] pins)
    {
        _inner = RustHandle<Raw.SliceParseError>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe SliceParseError(Raw.SliceParseError* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.SliceParseError>.Owned(handle, _destroy, dependencies, pins);
    }

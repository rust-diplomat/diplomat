...
public partial class DefaultDropProbe
{
    ...
    /// </remarks>
    internal unsafe DefaultDropProbe(Raw.DefaultDropProbe* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.DefaultDropProbe>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe DefaultDropProbe(Raw.DefaultDropProbe* handle, object[] pins)
    {
        _inner = RustHandle<Raw.DefaultDropProbe>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe DefaultDropProbe(Raw.DefaultDropProbe* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.DefaultDropProbe>.Owned(handle, _destroy, dependencies, pins);
    }

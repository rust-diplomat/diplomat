...
public partial class RenamedAttrOpaque2
{
    ...
    /// </remarks>
    internal unsafe RenamedAttrOpaque2(Raw.RenamedAttrOpaque2* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.RenamedAttrOpaque2>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe RenamedAttrOpaque2(Raw.RenamedAttrOpaque2* handle, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedAttrOpaque2>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe RenamedAttrOpaque2(Raw.RenamedAttrOpaque2* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedAttrOpaque2>.Owned(handle, _destroy, dependencies, pins);
    }

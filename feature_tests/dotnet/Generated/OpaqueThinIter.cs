...
public partial class OpaqueThinIter
{
    ...
    {
        _inner = RustHandle<Raw.OpaqueThinIter>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RustHandle<Raw.OpaqueThinIter>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RustHandle<Raw.OpaqueThinIter>.Owned(handle, _destroy, dependencies, pins);
    }

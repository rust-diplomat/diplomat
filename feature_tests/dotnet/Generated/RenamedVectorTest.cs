...
public partial class RenamedVectorTest: IDisposable
{
    ...
    /// </remarks>
    internal unsafe RenamedVectorTest(Raw.RenamedVectorTest* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.RenamedVectorTest>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe RenamedVectorTest(Raw.RenamedVectorTest* handle, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedVectorTest>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe RenamedVectorTest(Raw.RenamedVectorTest* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedVectorTest>.Owned(handle, _destroy, dependencies, pins);
    }

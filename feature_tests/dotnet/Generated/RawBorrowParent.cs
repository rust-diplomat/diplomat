...
internal static unsafe extern BorrowChild* View(BorrowParent* handle);
    ...
    [DllImport(DiplomatNativeLib.Name, EntryPoint = "BorrowParent_view_from", CallingConvention = CallingConvention.Cdecl)]
internal static unsafe extern BorrowChild* ViewFrom(BorrowParent* @this);

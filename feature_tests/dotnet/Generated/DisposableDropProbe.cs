...
public partial class DisposableDropProbe: IDisposable
{
    ...
    /// </remarks>
    internal unsafe DisposableDropProbe(Raw.DisposableDropProbe* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.DisposableDropProbe>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe DisposableDropProbe(Raw.DisposableDropProbe* handle, object[] pins)
    {
        _inner = RustHandle<Raw.DisposableDropProbe>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe DisposableDropProbe(Raw.DisposableDropProbe* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.DisposableDropProbe>.Owned(handle, _destroy, dependencies, pins);
    }

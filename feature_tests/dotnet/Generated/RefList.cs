...
public partial class RefList
{
    ...
    {
        _inner = RustHandle<Raw.RefList>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RustHandle<Raw.RefList>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RustHandle<Raw.RefList>.Owned(handle, _destroy, dependencies, pins);
    }

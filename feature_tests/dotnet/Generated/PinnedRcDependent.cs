...
public partial class PinnedRcDependent: IDisposable
{
    ...
    {
        _inner = RustHandle<Raw.PinnedRcDependent>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RustHandle<Raw.PinnedRcDependent>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RustHandle<Raw.PinnedRcDependent>.Owned(handle, _destroy, dependencies, pins);
    }

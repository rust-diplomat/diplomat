...
public partial class RenamedMixinTest
{
    ...
    /// </remarks>
    internal unsafe RenamedMixinTest(Raw.RenamedMixinTest* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.RenamedMixinTest>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe RenamedMixinTest(Raw.RenamedMixinTest* handle, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedMixinTest>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe RenamedMixinTest(Raw.RenamedMixinTest* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedMixinTest>.Owned(handle, _destroy, dependencies, pins);
    }

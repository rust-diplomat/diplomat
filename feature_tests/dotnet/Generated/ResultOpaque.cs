...
public partial class ResultOpaque: IDisposable
{
    ...
    /// </remarks>
    internal unsafe ResultOpaque(Raw.ResultOpaque* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.ResultOpaque>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe ResultOpaque(Raw.ResultOpaque* handle, object[] pins)
    {
        _inner = RustHandle<Raw.ResultOpaque>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe ResultOpaque(Raw.ResultOpaque* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.ResultOpaque>.Owned(handle, _destroy, dependencies, pins);
    }

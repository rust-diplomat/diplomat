...
public partial class RenamedOpaqueZSTIndexer
{
    ...
    /// </remarks>
    internal unsafe RenamedOpaqueZSTIndexer(Raw.RenamedOpaqueZSTIndexer* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.RenamedOpaqueZSTIndexer>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe RenamedOpaqueZSTIndexer(Raw.RenamedOpaqueZSTIndexer* handle, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedOpaqueZSTIndexer>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe RenamedOpaqueZSTIndexer(Raw.RenamedOpaqueZSTIndexer* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedOpaqueZSTIndexer>.Owned(handle, _destroy, dependencies, pins);
    }

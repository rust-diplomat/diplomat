...
public partial class RenamedTestOpaque
{
    ...
    /// </remarks>
    internal unsafe RenamedTestOpaque(Raw.RenamedTestOpaque* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.RenamedTestOpaque>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe RenamedTestOpaque(Raw.RenamedTestOpaque* handle, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedTestOpaque>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe RenamedTestOpaque(Raw.RenamedTestOpaque* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedTestOpaque>.Owned(handle, _destroy, dependencies, pins);
    }

...
public partial class Unnamespaced: IDisposable
{
    ...
    /// </remarks>
    internal unsafe Unnamespaced(Raw.Unnamespaced* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.Unnamespaced>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe Unnamespaced(Raw.Unnamespaced* handle, object[] pins)
    {
        _inner = RustHandle<Raw.Unnamespaced>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe Unnamespaced(Raw.Unnamespaced* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.Unnamespaced>.Owned(handle, _destroy, dependencies, pins);
    }

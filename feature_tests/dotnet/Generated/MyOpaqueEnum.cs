...
public partial class MyOpaqueEnum: IDisposable
{
    ...
    /// </remarks>
    internal unsafe MyOpaqueEnum(Raw.MyOpaqueEnum* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.MyOpaqueEnum>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe MyOpaqueEnum(Raw.MyOpaqueEnum* handle, object[] pins)
    {
        _inner = RustHandle<Raw.MyOpaqueEnum>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe MyOpaqueEnum(Raw.MyOpaqueEnum* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.MyOpaqueEnum>.Owned(handle, _destroy, dependencies, pins);
    }

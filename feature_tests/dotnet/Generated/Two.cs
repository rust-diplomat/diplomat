...
public partial class Two
{
    ...
    {
        _inner = RustHandle<Raw.Two>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RustHandle<Raw.Two>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RustHandle<Raw.Two>.Owned(handle, _destroy, dependencies, pins);
    }

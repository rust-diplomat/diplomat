...
public partial class RenamedNested
{
    ...
    /// </remarks>
    internal unsafe RenamedNested(Raw.RenamedNested* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.RenamedNested>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe RenamedNested(Raw.RenamedNested* handle, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedNested>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe RenamedNested(Raw.RenamedNested* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.RenamedNested>.Owned(handle, _destroy, dependencies, pins);
    }

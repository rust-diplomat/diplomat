...
public partial class RcDependent2: IDisposable
{
    ...
    {
        _inner = RustHandle<Raw.RcDependent2>.Owned(handle, _destroy, dependencies);
    }
    ...
    {
        _inner = RustHandle<Raw.RcDependent2>.Owned(handle, _destroy, pins);
    }
    ...
    {
        _inner = RustHandle<Raw.RcDependent2>.Owned(handle, _destroy, dependencies, pins);
    }

...
public partial class FixedDecimal
{
    ...
    /// </remarks>
    internal unsafe FixedDecimal(Raw.FixedDecimal* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.FixedDecimal>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe FixedDecimal(Raw.FixedDecimal* handle, object[] pins)
    {
        _inner = RustHandle<Raw.FixedDecimal>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe FixedDecimal(Raw.FixedDecimal* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.FixedDecimal>.Owned(handle, _destroy, dependencies, pins);
    }

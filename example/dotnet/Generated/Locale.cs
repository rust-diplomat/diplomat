...
public partial class Locale
{
    ...
    /// </remarks>
    internal unsafe Locale(Raw.Locale* handle, IRustHandleDependency[] dependencies)
    {
        _inner = RustHandle<Raw.Locale>.Owned(handle, _destroy, dependencies);
    }
    ...
    /// </summary>
    internal unsafe Locale(Raw.Locale* handle, object[] pins)
    {
        _inner = RustHandle<Raw.Locale>.Owned(handle, _destroy, pins);
    }
    ...
    /// </summary>
    internal unsafe Locale(Raw.Locale* handle, IRustHandleDependency[] dependencies, object[] pins)
    {
        _inner = RustHandle<Raw.Locale>.Owned(handle, _destroy, dependencies, pins);
    }

...
class ICU4XFixedDecimal {
 public:
  ...
  void ICU4XFixedDecimal_to_string(const ICU4XFixedDecimal& self, capi::DiplomatWriteable& to) {
    capi::ICU4XFixedDecimal_to_string(this->inner.get(), &to);
  }
...
class ICU4XFixedDecimalFormat {
 public:
  ...
  void ICU4XFixedDecimalFormat_format_write(const ICU4XFixedDecimalFormat& self, const ICU4XFixedDecimal& value, capi::DiplomatWriteable& write) {
    capi::ICU4XFixedDecimalFormat_format_write(this->inner.get(), value.AsFFI(), &write);
  }

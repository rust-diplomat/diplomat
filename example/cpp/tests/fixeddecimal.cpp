...
int main(int argc, char *argv[]) {
    icu4x::FixedDecimal fd = icu4x::FixedDecimal::new_(123);
    ...
    icu4x::Locale locale = icu4x::Locale::new_("bn");

    icu4x::DataProvider data_provider = icu4x::DataProvider::new_static();

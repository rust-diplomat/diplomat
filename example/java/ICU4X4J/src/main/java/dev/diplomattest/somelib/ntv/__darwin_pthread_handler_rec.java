...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        somelib_h.C_POINTER.withName("__routine"),
        somelib_h.C_POINTER.withName("__arg"),
        somelib_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = somelib_h.upcallHandle(__routine.Function.class, "apply", $DESC);

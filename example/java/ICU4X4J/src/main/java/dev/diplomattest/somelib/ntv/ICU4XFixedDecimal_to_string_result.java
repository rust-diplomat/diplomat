...
/**
 * {@snippet lang=c :
 * struct ICU4XFixedDecimal_to_string_result {
 *     bool is_ok;
 * }
 * }
 */
public class ICU4XFixedDecimal_to_string_result {

    ICU4XFixedDecimal_to_string_result() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        somelib_h.C_BOOL.withName("is_ok")
    ).withName("ICU4XFixedDecimal_to_string_result");

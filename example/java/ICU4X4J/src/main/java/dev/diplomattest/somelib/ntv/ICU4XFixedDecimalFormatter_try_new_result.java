...
/**
 * {@snippet lang=c :
 * struct ICU4XFixedDecimalFormatter_try_new_result {
 *     union {
 ...
 * }
 */
public class ICU4XFixedDecimalFormatter_try_new_result {
    ...
    ).withName("ICU4XFixedDecimalFormatter_try_new_result");
    ...
    private static final AddressLayout ok$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$22:51"), groupElement("ok"));

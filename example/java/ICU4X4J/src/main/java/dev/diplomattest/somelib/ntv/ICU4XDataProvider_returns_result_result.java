...
/**
 * {@snippet lang=c :
 * struct ICU4XDataProvider_returns_result_result {
 *     bool is_ok;
 * }
 * }
 */
public class ICU4XDataProvider_returns_result_result {

    ICU4XDataProvider_returns_result_result() {
        // Should not be called directly
    }

    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        somelib_h.C_BOOL.withName("is_ok")
    ).withName("ICU4XDataProvider_returns_result_result");
    ...
    private static final long is_ok$OFFSET = 0;

...
final class FixedDecimal implements ffi.Finalizable {
  ...
  static final _finalizer = ffi.NativeFinalizer(
      ffi.Native.addressOf(_icu4x_FixedDecimal_destroy_mv1));
...
@ffi.Native<ffi.Void Function(ffi.Pointer<ffi.Void>)>(
    isLeaf: true, symbol: 'icu4x_FixedDecimal_destroy_mv1')
...
@ffi.Native<ffi.Pointer<ffi.Opaque> Function(ffi.Int32)>(
    isLeaf: true, symbol: 'icu4x_FixedDecimal_new_mv1')
// ignore: non_constant_identifier_names
...
@ffi.Native<ffi.Void Function(ffi.Pointer<ffi.Opaque>, ffi.Int16)>(
    isLeaf: true, symbol: 'icu4x_FixedDecimal_multiply_pow10_mv1')
// ignore: non_constant_identifier_names
external void _icu4x_FixedDecimal_multiply_pow10_mv1(
...
@ffi.Native<
    ...
    isLeaf: true, symbol: 'icu4x_FixedDecimal_to_string_mv1')
// ignore: non_constant_identifier_names
external _ResultVoidVoid _icu4x_FixedDecimal_to_string_mv1(
    ffi.Pointer<ffi.Opaque> self, ffi.Pointer<ffi.Opaque> write);

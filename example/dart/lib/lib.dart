...
class ICU4XDataProvider implements ffi.Finalizable {
	...
	static late final _finalizer = ffi.NativeFinalizer(_capi('ICU4XDataProvider_destroy'));
...
factory ICU4XDataProvider.newStatic(){ 
	...
	static late final _newStaticFfi = _capi<ffi.NativeFunction<ffi.Pointer<ffi.Opaque> Function()>>('ICU4XDataProvider_new_static')
...
static void returnsResult(){ 
	...
	static late final _returnsResultFfi = _capi<ffi.NativeFunction<_ResultVoidVoid Function()>>('ICU4XDataProvider_returns_result')
...
class ICU4XFixedDecimal implements ffi.Finalizable {
	...
	static late final _finalizer = ffi.NativeFinalizer(_capi('ICU4XFixedDecimal_destroy'));
...
factory ICU4XFixedDecimal(int v){ 
	...
	static late final _newFfi = _capi<ffi.NativeFunction<ffi.Pointer<ffi.Opaque> Function(ffi.Int32)>>('ICU4XFixedDecimal_new')
...
void multiplyPow10(int power){ 
	...
	static late final _multiplyPow10Ffi = _capi<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Opaque>, ffi.Int16)>>('ICU4XFixedDecimal_multiply_pow10')
...
String toString(){ 
	...
	static late final _toStringFfi = _capi<ffi.NativeFunction<_ResultVoidVoid Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>>('ICU4XFixedDecimal_to_string')
...
class ICU4XFixedDecimalFormatter implements ffi.Finalizable {
	...
	static late final _finalizer = ffi.NativeFinalizer(_capi('ICU4XFixedDecimalFormatter_destroy'));
...
factory ICU4XFixedDecimalFormatter.tryNew(ICU4XLocale locale, ICU4XDataProvider provider, ICU4XFixedDecimalFormatterOptions options){ 
		final result = _tryNewFfi(locale._underlying,provider._underlying,options._underlying);
		return result.isOk ? ICU4XFixedDecimalFormatter._(result.union.ok) : throw VoidError();
  }
	static late final _tryNewFfi = _capi<ffi.NativeFunction<_ResultOpaqueVoid Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, _ICU4XFixedDecimalFormatterOptionsFfi)>>('ICU4XFixedDecimalFormatter_try_new')
...
String formatWrite(ICU4XFixedDecimal value){ 
	...
	static late final _formatWriteFfi = _capi<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>, ffi.Pointer<ffi.Opaque>)>>('ICU4XFixedDecimalFormatter_format_write')
...
class ICU4XFixedDecimalFormatterOptions {
	...
	ICU4XFixedDecimalGroupingStrategy get groupingStrategy => ICU4XFixedDecimalGroupingStrategy._(this._underlying.groupingStrategy);
	void set groupingStrategy(ICU4XFixedDecimalGroupingStrategy groupingStrategy) {this._underlying.groupingStrategy = groupingStrategy._id;
	}
...
factory ICU4XFixedDecimalFormatterOptions.default(){ 
	...
	static late final _defaultFfi = _capi<ffi.NativeFunction<_ICU4XFixedDecimalFormatterOptionsFfi Function()>>('ICU4XFixedDecimalFormatterOptions_default')
...
enum ICU4XFixedDecimalGroupingStrategy {
  ...
  factory ICU4XFixedDecimalGroupingStrategy._(int id) => values.firstWhere((value) => value._id == id);
...
class ICU4XLocale implements ffi.Finalizable {
	...
	static late final _finalizer = ffi.NativeFinalizer(_capi('ICU4XLocale_destroy'));
...
factory ICU4XLocale(String name){ 
		...
		nameBytes.cast<ffi.Uint8>().asTypedList(nameList.length).setAll(0, nameList);

		final result = _newFfi(nameBytes.cast(),nameList.length);alloc.releaseAll();
		return ICU4XLocale._(result);
  }
	static late final _newFfi = _capi<ffi.NativeFunction<ffi.Pointer<ffi.Opaque> Function(ffi.Pointer<ffi.Char>, ffi.Size)>>('ICU4XLocale_new')
...
bytesBytes.asTypedList(bytes.length).setAll(0, bytes);
		...
		final result = _newFromBytesFfi(bytesBytes.cast(),bytes.length);alloc.releaseAll();
		return ICU4XLocale._(result);
  }
	static late final _newFromBytesFfi = _capi<ffi.NativeFunction<ffi.Pointer<ffi.Opaque> Function(ffi.Pointer<ffi.Uint8>, ffi.Size)>>('ICU4XLocale_new_from_bytes')

...
impl<'tcx> TyGenContext<'_, 'tcx> {
    ...
    pub(super) fn gen_enum(
        ...
        ImplTemplate {
            ...
            doc_str: self
                .formatter
                .fmt_docs(&enum_def.docs, enum_def.attrs.deprecated.as_deref()),
            is_contiguous,
    ...
    pub(super) fn gen_opaque(
        ...
        ImplTemplate {
            ...
            doc_str: self
                .formatter
                .fmt_docs(&opaque_def.docs, opaque_def.attrs.deprecated.as_deref()),
    ...
    pub(super) fn gen_struct<P: hir::TyPosition>(
        ...
        ImplTemplate {
            ...
            doc_str: self
                .formatter
                .fmt_docs(&struct_def.docs, struct_def.attrs.deprecated.as_deref()),
    ...
    pub(super) fn generate_method(
        ...
        let mut method_info = MethodInfo {
            ...
            doc_str: self
                .formatter
                .fmt_docs(&method.docs, method.attrs.deprecated.as_deref()),
            ..Default::default()
        };

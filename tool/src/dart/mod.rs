...
impl<'a, 'cx> TyGenContext<'a, 'cx> {
    ...
    fn gen_self_type_ffi(&self, ty: &SelfType, cast: bool) -> Cow<'cx, str> {
        match ty {
    ...
    fn gen_dart_return_type_name(&mut self, result_ty: &ReturnType) -> Cow<'cx, str> {
        match *result_ty {
    ...
    fn gen_ffi_return_type_name(&mut self, result_ty: &ReturnType, cast: bool) -> Cow<'cx, str> {
        match *result_ty {
